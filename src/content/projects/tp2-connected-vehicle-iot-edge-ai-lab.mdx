...
<figure class="not-prose my-8">
  <div class="overflow-hidden rounded-2xl border bg-white/70 shadow-[var(--shadow-soft)]">
    <img
      src="/images/projects/tp2-architecture.png"
      alt="TP2 connected vehicle architecture showing the operator laptop, EPC, eNodeB, car, and Jetson roles, plus LTE, UDP, SSH, and planned inference-offload flows."
      loading="lazy"
      class="w-full"
    />
  </div>
